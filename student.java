...
// Analyze the concept and identify the data members that a Student class should have.
//  Also analyze the behavior of student in a university management System and identify the 
//  methods that should be included in Student class.
...
class Management{
	...
	void display()
	{
		System.out.println(id+"\t"+name+"\t"+departement+"\t"+reg_no+"\t"+dob+"\t"+address);
		System.out.println();
